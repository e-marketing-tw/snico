...
link.rel = 'stylesheet';
link.type = 'text/css';
link.href = 'http://www.syeson.com.tw/dortek/API/css/scss.css';
var link2 = document.createElement('link');
link2.rel = 'stylesheet';
link2.type = 'text/css';
link2.href = 'http://www.syeson.com.tw/dortek/API/css/style-video.css';
document.getElementsByTagName('body')[0].appendChild(link);
document.getElementsByTagName('body')[0].appendChild(link2);
var ai_body = document.getElementsByTagName("body");
var ai_flipbook = document.createElement('div');
var ai_fixbtm = document.createElement('div');
var ai_fixbtm_in = document.createElement('div');
ai_body[0].appendChild(ai_flipbook);
ai_flipbook.setAttribute("id", "avater");
ai_flipbook.setAttribute("class", "avater_flipbook");
$('#avater').html(flipbook_html).hide();
ai_body[0].appendChild(ai_fixbtm_in);
ai_fixbtm_in.setAttribute("id", "draggable_in");
$('#draggable_in').html(add_html_in);
ai_body[0].appendChild(ai_fixbtm);
ai_fixbtm.setAttribute("id", "draggable");
var link_date = document.createElement('div');
var link_date_html = '<div class="link_date_box"><div class="link_date_bg"><div class="close_link_date"><img src="http://www.syeson.com.tw/dortek/API/icon/close_icon_ai.png" alt=""></div><div class="in_date_box"></div></div></div>'
ai_body[0].appendChild(link_date);
link_date.setAttribute("class", "link_date_box");
$('.link_date_box').html(link_date_html);
...
var add_top_two = "<div class='player_now first_play'></div><div class='loader'><span></span><span></span><span></span><span></span></div><div class='sj_right_nav'><p class='sound'><img class='sound_off' src='http://www.syeson.com.tw/dortek/API/icon/sound_off.png' alt><img class='sound_on' src='http://www.syeson.com.tw/dortek/API/icon/sound_on.png' alt></p><p class='close_play'><img src='http://www.syeson.com.tw/dortek/API/icon/close_icon.png' alt></p></div><div class='vid_nav'><p class='re_play'><img src='http://www.syeson.com.tw/dortek/API/icon/re_play_icon_b.png' alt></p><div class='sj_lang_nav'><p class='flag_nav' data-id='tw'><img src='http://www.syeson.com.tw/dortek/API/flag/cmn-TW.png' alt><span>tw</span></p><a class='lang_mmen' href='javascript:;' title=''><span></span></a></div><div class='sj_bottom_nav'><p class='sj_lang_close'><img src='http://www.syeson.com.tw/dortek/API/icon/close_icon.png' alt></p><p>AI Language</p><div class='overflow_box'>";
//國家 系統有的AI語系要出現在這邊//
var add_center = "<div class='bottom_nav_box now_lang' id='cmn-TW'><a class='flag_lang' href='javascript:;' title='tw' data-url=''><img src='http://www.syeson.com.tw/dortek/API/flag/cmn-TW.png' alt><p>TW</p></a></div><div class='bottom_nav_box' id='cmn-CN'><a class='flag_lang' href='javascript:;' title='ch' data-url=''><img src='http://www.syeson.com.tw/dortek/API/flag/cmn-CN.png' alt><p>CH</p></a></div><div class='bottom_nav_box' id='en-US'><a class='flag_lang' href='javascript:;' title='us' data-url=''><img src='http://www.syeson.com.tw/dortek/API/flag/en-US.png' alt><p>US</p></a></div><div class='bottom_nav_box' id='ja-JP'><a class='flag_lang' href='javascript:;' title='jp' data-url=''><img src='http://www.syeson.com.tw/dortek/API/flag/ja-JP.png' alt><p>JP</p></a></div><div class='bottom_nav_box' id='es-ES'><a class='flag_lang' href='javascript:;' title='es' data-url=''><img src='http://www.syeson.com.tw/dortek/API/flag/es-ES.png' alt><p>ES</p></a></div><div class='bottom_nav_box' id='fr-FR'><a class='flag_lang' href='javascript:;' title='fr' data-url=''><img src='http://www.syeson.com.tw/dortek/API/flag/fr-FR.png' alt><p>FR</p></a></div><div class='bottom_nav_box' id='pt-PT'><a class='flag_lang' href='javascript:;' title='pt' data-url=''><img src='http://www.syeson.com.tw/dortek/API/flag/pt-PT.png' alt><p>PT</p></a></div><div class='bottom_nav_box' id='de-DE'><a class='flag_lang' href='javascript:;' title='de' data-url=''><img src='http://www.syeson.com.tw/dortek/API/flag/de-DE.png' alt><p>DE</p></a></div><div class='bottom_nav_box' id='tr-TR'><a class='flag_lang' href='javascript:;' title='tr' data-url=''><img src='http://www.syeson.com.tw/dortek/API/flag/tr-TR.png' alt><p>TR</p></a></div><div class='bottom_nav_box' id='ar-SA'><a class='flag_lang' href='javascript:;' title='sa' data-url=''><img src='http://www.syeson.com.tw/dortek/API/flag/ar-SA.png' alt><p>SA</p></a></div>";
...
tag2.src = "http://www.syeson.com.tw/dortek/API/jquery-ui.min.js";
...
function getJindu() {
    if (a) {
            ...
            if (now_time < go_prev) {
                ...
                if (next_time) {
                    ...
                    if (now_time2 == go_time) {
                       $('.now_date_avater').find('.now_slider').children('.play_video').click();
                    }
                    if (now_time > go_time) {
                        var table_length = $(date_id).find('.avater_slider_in').length,
        ...
        if (now_time > duration) {
            ...
            if (play_time) {
                $(date_id).find('.now_slider').find('.play_video').click();
            }
...
function avaterplayVideo() {
    player_avater.playVideo();
    player_avater.unMute();
}
...
function addvid(e) {
    ...
    if(typeof img != 'undefined' && typeof img != ''){
        i = 0
...
function playt_in(vid) {
    stopTimer_in();
    ($('#player_in_out').length>0) && player_in_out.loadVideoById(vid, 0);
}
function addvid_in() {
...
function area_active() {
    if ($('.area_point').hasClass('now_avater_date')) {
        var now_point=$('.area_point.now_avater_date'),
            active_coords = now_point.attr('coords');
        i = 0;
...
$(window).on("load", function (e) {
    $('.flipbook_type_date').addClass('api_type');
    ...
    if(typeof str != 'undefined' && typeof img != ''){
        i = 0
        const arr = str.split(",");
        $('.bottom_nav_box_in').hide();
        for (i = 0; i < 20; i++) {　
    ...
    $(".avater_open").click(function () {
        $('.avater_flipbook').addClass('show_in').fadeIn(300);
        AIpauseVideo_in()
        $('.sjvid_box_in, #draggable_in').removeClass('show_in');
        setTimeout(function () {
            AIallstop_in()
            $('.player_box_in, .player_now_in, .sj_right_nav_in').removeClass('playing');
            $('.img_avater_box_in, .video_avater_box_in').removeAttr('style');
        }, 301);
    ...
    $(".close_avater").click(function () {
        ...
        $('.flipbook_outbox').removeClass('canmove')
    ...
    $('.avater_date_dot p').click(function () {
        if (!$(this).hasClass('active')) {
            ...
            $(this).parent('.avater_date_dot').prevAll('.avater_date_img').find('.avater_slider_in').eq(th).addClass('now_slider').siblings('.avater_slider_in').removeClass('now_slider')
    ...
    $(".fullscreen").click(function () {
        $(this).stop().toggleClass('full');
        // $('.avater_date_box, #draggable').stop().toggleClass('full');
        $('.avater_date_box').stop().toggleClass('full');
        setTimeout(function () {
            control_nav_rwd()
        }, 100);
        return false;
    ...
    function share_url_in() {
        ...
        if (/Android|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)) {
            var whatsapp_url = '//api.whatsapp.com/send?text=';
        } else {
            var whatsapp_url = '//web.whatsapp.com/send?';
        }
        /*臉書*/
        $('.facebook').attr('href', '//www.facebook.com/share.php?u=' + now_url);
        /*推特*/
        $('.twitter').attr('href', 'http://twitter.com/home/?status=' + now_url);
        /*微博*/
        $('.weibo').attr('href', '//service.weibo.com/share/share.php?appkey=&title=' + share_title + '&url=' + now_url + '&searchPic=false&style=simple');
        /*LINE*/
        $('.line').attr('href', '//lineit.line.me/share/ui?url=' + now_url);
        /*Skype*/
        $('.skype').attr('href', '//web.skype.com/share?url=' + now_url);
        /*Whatsapp*/
    ...
    $(".zoom_avater").click(function () {
        ...
        if(!_.hasClass('in')){
            _.addClass('in');
            _.find('p').text(_.data('in'))
        }else{
            _.removeClass('in');
            _.find('p').text(_.data('zoom'))
        }
        return false;
    });
    //打開分享視窗
    ...
    $(".contact_avater").click(function () {
        $('.contact_avater_box').stop().fadeIn();
        $('.avater_date_box').removeClass('show_in');
        $('.progress_btn, .progress_bar').removeAttr('style');
        AIallstop()
        avaterstopVideo()
    ...
    var moveAi = document.querySelector('#draggable');
    ...
    if ($("#draggable_in").length > 0) {
        var moveAiIn = document.querySelector('#draggable_in');
